    ...
    await api
      ...
      .then((data) => {
        ...
        if (data.data.message === "sucess") {
          ...
          id = setInterval(() => {
            navigete(`/recibo_inscrincao/${data.data?.response?.id}`);
