...
const ReciboMatricula = () => {
  ...
  const getInfomation = async () => {
    try {
      await api.get(`/matricula/${id}`).then((data) => {
  ...
  const imprimir = async (e) => {
    ...
    estilo += ".tabelaMatricula{display: flex; flex-direction: row;gap:20px;}";
    estilo += ".tabelaMatricula div{width: 90%;}";
  ...
  return (
    <div className='relatorioMatricula'>
      <div className='imprimirMatricula'>
        ...
        <Link
          ...
          to={`/dashboard/matricula/${2}?active=mat`}
          className='LinkFechar'>
          fechar{" "}
        </Link>
      </div>
      <div id='tabela' className='div'>
        <div className='tabelaMatricula'>
          <div>
            <img src={image} alt='ISPM' />
            <div className='extra'>
              <h4>Tipo de Serviço: Matrícula</h4>
            ...
            <table>
              <thead>
                <tr className='estudante'>
                  <th colSpan={6}> Dados de Matrícula</th>
                </tr>
              </thead>
          ...
          <div>
            ...
            <table>
              <thead>
                <tr className='estudante'>
                  <th colSpan={6}> Dados da Matrícula</th>
                </tr>
              </thead>
...
export default ReciboMatricula;
