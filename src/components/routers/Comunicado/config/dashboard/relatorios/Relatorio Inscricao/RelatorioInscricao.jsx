...
import "./relatorioInscricao.scss";
...
const RelatorioInscricao = () => {
  ...
  return (
    <>
      ...
      <div className='relatorioInscricao'>
        {dados?.length > 0 && (
          <Button
            type='primary'
            onClick={() => imprimir()}
...
export default RelatorioInscricao;
